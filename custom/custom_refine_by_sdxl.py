...
def refine(cfg):
    ...
    # using custom vae to fix the error: RuntimeError: expected scalar type Half but found Float
    ...
    # offload unet and text encoder to CPU to fit into GPU memory (using pipe.to("cuda") if having enough GPU memory)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_dir', type=str, required=True,
                        help='base directory containing GS data (used as data_dir)')
